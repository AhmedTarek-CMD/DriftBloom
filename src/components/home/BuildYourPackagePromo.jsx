...
import { Reveal, Stagger, fadeUp } from "../common/Motion.jsx";
import plantImage from "../../assets/plants.jpeg";
import candleImage from "../../assets/candles.jpeg";
import fishImage from "../../assets/fishs.jpeg";
...
function PackageCategoryCard({ category }) {
  return (
    ...
    >
      <Link
        to={`/build-your-package?category=${category.id}`}
